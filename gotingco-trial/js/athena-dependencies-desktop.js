 ...
 * Build http://modernizr.com/download/#-search-svg-mq-shiv-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
...
(function () {
    ...
    yepnope([
        ...
        // for older browsers.
        // Once we no longer need to support IE8, we can build enquire into
        // the main dependency build.
        {
            test: window.matchMedia,
            nope: path + 'media.match.min-774fd9af.js'
        },
        path + 'enquire.min-c22ea088.js',
        path + 'athena-desktop.min-39230e5b.js'
    ]);
